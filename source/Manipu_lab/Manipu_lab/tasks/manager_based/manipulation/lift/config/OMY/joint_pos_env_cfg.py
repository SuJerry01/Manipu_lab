...
from Manipu_lab.tasks.manager_based.manipulation.lift.config.OMY.lift_env_cfg import LiftEnvCfg

##
# Pre-defined configs
##
from Manipu_lab.assets.OMY import OMY_HIGH_PD_CFG  # isort: skip
