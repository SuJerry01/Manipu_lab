...
from Manipu_lab.tasks.manager_based.manipulation.lift import mdp
from Manipu_lab.tasks.manager_based.manipulation.lift.lift_env_cfg import LiftEnvCfg

##
# Pre-defined configs
##
from isaaclab.markers.config import FRAME_MARKER_CFG  # isort: skip
from Manipu_lab.assets import PIPER_CFG  # isort: skip
...
class PiperCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        # Set the body name for the end effector  (修改为夹爪所在的 link 名称，本例中为 link6)
