...
from Manipu_lab.tasks.manager_based.manipulation.reach.reach_env_cfg import ReachEnvCfg

##
# Pre-defined configs
##
from Manipu_lab.assets.universal_robots import UR10_CFG  # isort: skip
