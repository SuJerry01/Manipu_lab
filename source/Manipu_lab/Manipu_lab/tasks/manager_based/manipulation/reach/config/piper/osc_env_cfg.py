...
class PiperReachEnvCfg(joint_pos_env_cfg.PiperReachEnvCfg):
    def __post_init__(self):
        ...
        # Set Piper as robot
        # We remove stiffness and damping for the arm joints for effort control
        self.scene.robot = PIPER_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        self.scene.robot.actuators["piper_arm"].stiffness = 0.0
        self.scene.robot.actuators["piper_arm"].damping = 0.0
