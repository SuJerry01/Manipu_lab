...
from Manipu_lab.assets.FFW_BG2 import FFW_BG2_CFG  # isort: skip
...
class FFWBG2ReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        ...
        self.commands.ee_pose_l.ranges.pitch = (math.pi, math.pi)
        self.commands.ee_pose_r.body_name = ee_link_r
        self.commands.ee_pose_r.ranges.pitch = (math.pi, math.pi)
