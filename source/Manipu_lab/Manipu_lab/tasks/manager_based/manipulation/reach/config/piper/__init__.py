...
##
# CuRobo Motion Planning Control
##

gym.register(
    id="Isaac-Reach-Piper-CuRobo-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.curobo_env_cfg:PiperReachCuRoboEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PiperReachPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
    },
)
...
gym.register(
    id="Isaac-Reach-Piper-CuRobo-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.curobo_env_cfg:PiperReachCuRoboEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PiperReachPPORunnerCfg",
    },
)

gym.register(
    id="Isaac-Reach-Piper-CuRobo-Fast-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.curobo_env_cfg:PiperReachCuRoboEnvCfg_FAST",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PiperReachPPORunnerCfg",
    },
)

gym.register(
    id="Isaac-Reach-Piper-CuRobo-HighQuality-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.curobo_env_cfg:PiperReachCuRoboEnvCfg_HIGHQUALITY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:PiperReachPPORunnerCfg",
    },
)
