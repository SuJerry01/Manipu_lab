...
from Manipu_lab.tasks.manager_based.manipulation.cabinet import mdp

from Manipu_lab.tasks.manager_based.manipulation.cabinet.cabinet_env_cfg import (  # isort: skip
...
# Pre-defined configs
##
from Manipu_lab.assets import FRANKA_PANDA_CFG  # isort: skip
