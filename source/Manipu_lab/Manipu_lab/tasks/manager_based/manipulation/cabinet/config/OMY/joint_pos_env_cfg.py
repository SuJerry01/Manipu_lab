...
from Manipu_lab.tasks.manager_based.manipulation.cabinet.config.OMY import mdp
from Manipu_lab.tasks.manager_based.manipulation.cabinet.config.OMY.cabinet_env_cfg import (  # isort: skip
