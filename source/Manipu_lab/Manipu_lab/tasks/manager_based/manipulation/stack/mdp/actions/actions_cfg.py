...
# convert abs joint position action to binary joint position action
@configclass
class AbsBinaryJointActionCfg(ActionTermCfg):
    """Configuration for the base binary joint action term.
    ...
    """Whether to use positive threshold. Defaults to True."""


@configclass
class AbsBinaryJointPositionActionCfg(AbsBinaryJointActionCfg):
    """Configuration for the binary joint position action term.
...
# Directly use the joint position action as gripper action
@configclass
class AbsGripperJointPositionActionCfg(JointActionCfg):
    """Configuration for the binary joint position action term.

    See :class:`BinaryJointPositionAction` for more details.
    """

    class_type: type[ActionTerm] = joint_actions.AbsGripperJointPositionAction
