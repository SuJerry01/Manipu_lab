...
gym.register(
    ...
    kwargs={
        ...
        ),  # bc_transformer_low_dim
    },
    disable_env_checker=True,
)

gym.register(
    id="Isaac-Stack-Cube-Franka-Robotiq-Gripper-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": stack_ik_rel_env_cfg.FrankaRobotiqGripperCubeStackEnvCfg,
...
##
# RMPFlow with Joint Limit Constraint and Obstacle Avoidance
##

gym.register(
    id="Isaac-Stack-Cube-Franka-RmpFlow-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": stack_ik_rel_env_cfg.RmpFlowFrankaCubeStackEnvCfg,
        "robomimic_bc_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc_rnn_low_dim.json"),
    },
    disable_env_checker=True,
)
