...
from .manipu_lab_marl_env_cfg import ManipuLabMarlEnvCfg


class ManipuLabMarlEnv(DirectMARLEnv):
    cfg: ManipuLabMarlEnvCfg

    def __init__(self, cfg: ManipuLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
